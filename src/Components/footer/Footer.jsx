...
import {  FacebookOutlined, Google, Instagram, LocalGroceryStoreOutlined, X, YouTube } from "@mui/icons-material";
import {
  Box,
  Grid,
  List,
  ...
  return (
    ...
    >
      ...
      >
        ...
        justifyContent={"start"} flexDirection={"row"} alignItems={"center"}>
    ...
    >
        ...
        <img style={{
            width:"30px"
        }} src={googleIcon} alt="Google play icon" />
    ...
    >
        ...
        <img style={{
            width:"30px"
        }} src={appStoreIcon} alt="Google play icon" />
